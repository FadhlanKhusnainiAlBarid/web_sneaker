...
import { changeTotalPrice, fetchCarts } from "../app/actionsCart";
  ...
  return (
    <>
      <div className="container mx-auto px-2">
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-4 pt-4 h-full">
          <div className="2xl:col-start-2 lg:col-start-0 col-span-8 2xl:col-span-7 px-2">
            <div className="flex flex-col items-center justify-center lg:items-start leading-3.5 lg:mb-3.5">
              ...
              <HR className="lg:hidden block dark:bg-gray-200 w-full mt-7 mb-0" />
            </div>
          ...
          <div className="xl:col-span-4 lg:col-span-4 col-end-12 px-2 pb-6">
            ...
            <div className="text-lg font-medium space-y-0 lg:space-y-2.5 leading-">
              <span className="flex justify-between">
                Subtotal <p>{Rupiah.format(totalPrice)}</p>
              </span>
              <span className="flex justify-between">
      ...
      <div className="flex justify-center lg:hidden w-full sticky bottom-0 border-t-2 border-0 border-gray-200 bg-white">
